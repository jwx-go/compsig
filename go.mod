module github.com/jwx-go/compsig/v4
...
require (
	...
	github.com/jwx-go/ed448/v4 v4.0.0-alpha4.0.20260418154207-8f0c34fe58b3
	github.com/jwx-go/mldsa/v4 v4.0.0-alpha3.0.20260418154336-fafeb603817c
